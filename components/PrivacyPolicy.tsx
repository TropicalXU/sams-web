...
const PrivacyPolicy = () => {
  return (
    <div className={`${styles.xPaddings} p-12 relative z-10 mt-[60px]`}>
        <div className="container bg-gradient-to-r from-[#fff] to-[#f0f4f8] rounded-2xl shadow-lg p-8 md:p-12 mb-12">
            <h1 className="text-center text-[48px] font-bold text-darkestBlue mb-8">Privacy Policy</h1>
            <p className="text-base md:text-lg text-darkGray mb-6">
            We respect your privacy and are committed to protecting it through our compliance with this privacy policy (“Policy”). This Policy describes the types of information we may collect from you or that you may provide (“Personal Information”) on the <a target="_blank" rel="noreferrer" href="https://www.layerlabs.io">Samuel Gasilan</a> website (“Website” or “Service”) and any of its related products and services (collectively, “Services”), and our practices for collecting, using, maintaining, protecting, and disclosing that Personal Information. It also describes the choices available to you regarding our use of your Personal Information and how you can access and update it.
            </p>
            <p className="text-base md:text-lg text-darkGray mb-6">
            ...
            <h2 className="text-[36px] font-semibold text-darkestBlue my-6">Collection of personal information</h2>
            <p className="text-base md:text-lg text-darkGray mb-6">
            ...
            <ul className='list-disc text-base md:text-lg text-darkGray mb-6 px-6 py-2'>
            ...
            <h2 className="text-[36px] font-semibold text-darkestBlue my-6">Privacy of children</h2>
            <p className="text-base md:text-lg text-darkGray mb-6">
            ...
            <h2 className="text-[36px] font-semibold text-darkestBlue my-6">Use and processing of collected information</h2>
            <p className="text-base md:text-lg text-darkGray mb-6">
            ...
            <h2 className="text-[36px] font-semibold text-darkestBlue my-6">Disclosure of information</h2>
            <p className="text-base md:text-lg text-darkGray mb-6">
            ...
            <h2 className="text-[36px] font-semibold text-darkestBlue my-6">Retention of information</h2>
            <p className="text-base md:text-lg text-darkGray mb-6">
            ...
            <h2 className="text-[36px] font-semibold text-darkestBlue my-6">Do Not Track signals</h2>
            <p className="text-base md:text-lg text-darkGray mb-6">
            ...
            <h2 className="text-[36px] font-semibold text-darkestBlue my-6">Links to other resources</h2>
            <p className="text-base md:text-lg text-darkGray mb-6">
            The Website and Services contain links to other resources that are not owned or controlled by us. Please be aware that we are not responsible for the privacy practices of such other resources or third parties. We encourage you to be aware when you leave the Website and Services and to read the privacy statements of each and every resource that may collect Personal Information.
            </p>
            <h2 className="text-[36px] font-semibold text-darkestBlue my-6">Information security</h2>
            <p className="text-base md:text-lg text-darkGray mb-6">
            ...
            <h2 className="text-[36px] font-semibold text-darkestBlue my-6">Data breach</h2>
            <p className="text-base md:text-lg text-darkGray mb-6">
            ...
            <h2 className="text-[36px] font-semibold text-darkestBlue my-6">Changes and amendments</h2>
            <p className="text-base md:text-lg text-darkGray mb-6">
