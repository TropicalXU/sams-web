  ...
  return (
    <div className={`${styles.xPaddings} p-12 relative z-10 mt-[60px]`}>
      <div className="container bg-gradient-to-r from-[#fff] to-[#f0f4f8] rounded-2xl shadow-lg p-8 md:p-12 mb-12">
        ...
        <h2 className="text-[36px] font-semibold text-darkestBlue my-6">Prohibited Uses</h2>
        <p className="text-base md:text-lg text-darkGray mb-6">
        ...
        <h2 className="text-[36px] font-semibold text-darkestBlue my-6">Intellectual Property Rights</h2>
        <p className="text-base md:text-lg text-darkGray mb-6">
        ...
        <h2 className="text-[36px] font-semibold text-darkestBlue my-6">Limitation of Liability</h2>
        <p className="text-base md:text-lg text-darkGray mb-6">
        ...
        <h2 className="text-[36px] font-semibold text-darkestBlue my-6">Indemnification</h2>
        <p className="text-base md:text-lg text-darkGray mb-6">
          You agree to indemnify and hold the Operator and its affiliates, directors, officers, employees, agents, suppliers and licensors harmless from and against any liabilities, losses, damages or costs, including reasonable attorneys’ fees, incurred in connection with or arising from any third party allegations, claims, actions, disputes, or demands asserted against any of them as a result of or relating to your Content, your use of the Website and Services or any willful misconduct on your part.
        </p>

        <h2 className="text-[36px] font-semibold text-darkestBlue my-6">Severability</h2>
        <p className="text-base md:text-lg text-darkGray mb-6">
        ...
        <h2 className="text-[36px] font-semibold text-darkestBlue my-6">Dispute Resolution</h2>
        <p className="text-base md:text-lg text-darkGray mb-6">
        ...
        <p className="text-base md:text-lg text-darkGray mb-6">l&#97;y&#101;rl&#97;b&#115;&#46;&#105;&#111;&#64;&#103;m&#97;il&#46;&#99;o&#109;</p>
        <p className="text-base md:text-lg text-darkGray">This document was last updated on September 6, 2024</p>
      </div>
    </div>
  );
};
